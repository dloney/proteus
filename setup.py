...
PROTEUS_PETSC_EXTRA_LINK_ARGS = getattr(
    config, 'PROTEUS_PETSC_EXTRA_LINK_ARGS', [])
PROTEUS_PETSC_EXTRA_COMPILE_ARGS = getattr(
    config, 'PROTEUS_PETSC_EXTRA_COMPILE_ARGS', [])
...
for arg in sys.argv:
    if arg.startswith('--root'):
        proteus_install_path = proteus_install_path.partition(
            sys.prefix + '/')[-1]
        break
...
EXTENSIONS_TO_BUILD = [  # Extension("MeshAdaptPUMI.MeshAdaptPUMI",
    ...
    Extension("mprans.cMCorr3P",
              ...
              depends=["proteus/mprans/MCorr3P.h",
                       'proteus/ModelFactory.h', 'proteus/CompKernel.h'],
    ...
    Extension("richards.cRichards", ['proteus/richards/cRichards.pyx'],
              depends=['proteus/richards/Richards.h',
                       'proteus/ModelFactory.h', 'proteus/CompKernel.h'],
              language='c++',
              extra_compile_args=PROTEUS_OPT,
              include_dirs=[numpy.get_include(), 'proteus']),
    Extension("elastoplastic.cElastoPlastic",
              ...
              define_macros=[('PROTEUS_LAPACK_H',
                             ...
                             ('PROTEUS_BLAS_H',
                              PROTEUS_BLAS_H)],
              depends=['proteus/elastoplastic/ElastoPlastic.h',
                       'proteus/ModelFactory.h', 'proteus/CompKernel.h'],
              language='c++',
              include_dirs=[numpy.get_include(), 'proteus'],
              library_dirs=[PROTEUS_LAPACK_LIB_DIR,
    ...
    Extension("mprans.cRANS3PF", ['proteus/mprans/cRANS3PF.pyx'],
              depends=['proteus/mprans/RANS3PF.h', 'proteus/mprans/RANS3PF2D.h',
                       'proteus/ModelFactory.h', 'proteus/CompKernel.h'],
              language='c++',
              extra_compile_args=PROTEUS_OPT,
              include_dirs=[numpy.get_include(), 'proteus']),
    Extension("mprans.cRANS3PSed", ['proteus/mprans/cRANS3PSed.pyx'],
              depends=['proteus/mprans/RANS3PSed.h', 'proteus/mprans/RANS3PSed2D.h',
                       'proteus/ModelFactory.h', 'proteus/CompKernel.h'],
              language='c++',
              extra_compile_args=PROTEUS_OPT,
              include_dirs=[numpy.get_include(), 'proteus']),
    ...
    Extension("ADR", ['proteus/ADR.pyx'],
              depends=[
        'proteus/ADR.h', 'proteus/ModelFactory.h', 'proteus/CompKernel.h'],
        language='c++',
        extra_compile_args=PROTEUS_OPT,
        include_dirs=[numpy.get_include(), 'proteus']),
    ...
    Extension("cmeshTools",
              ['proteus/cmeshTools.pyx',
               'proteus/mesh.cpp', 'proteus/meshio.cpp'],
              language='c++',
              ...
              library_dirs=[PROTEUS_DAETK_LIB_DIR] + PROTEUS_PETSC_LIB_DIRS + \
              PROTEUS_MPI_LIB_DIRS + PROTEUS_HDF5_LIB_DIRS,
              libraries=['hdf5', 'stdc++', 'm', PROTEUS_DAETK_LIB] + \
              PROTEUS_PETSC_LIBS + PROTEUS_MPI_LIBS + PROTEUS_HDF5_LIBS,
    ...
    Extension('ctransportCoefficients',
              ['proteus/ctransportCoefficients.pyx',
                  'proteus/transportCoefficients.c'],
              include_dirs=[numpy.get_include(), 'proteus'],
    ...
    Extension("cpostprocessing",
              ...
              depends=["proteus/postprocessing.h",
                       "proteus/postprocessing.pxd"],
    ...
    Extension("cTwophaseDarcyCoefficients",
              ...
              PROTEUS_MPI_INCLUDE_DIRS,
              language="c++",
              library_dirs=PROTEUS_PETSC_LIB_DIRS + \
              PROTEUS_MPI_LIB_DIRS + PROTEUS_HDF5_LIB_DIRS,
              libraries=['hdf5', 'stdc++', 'm'] + PROTEUS_PETSC_LIBS + \
              PROTEUS_MPI_LIBS + PROTEUS_HDF5_LIBS,
              extra_compile_args=PROTEUS_EXTRA_COMPILE_ARGS + \
              PROTEUS_PETSC_EXTRA_COMPILE_ARGS + PROTEUS_OPT,
              extra_link_args=PROTEUS_EXTRA_LINK_ARGS + PROTEUS_PETSC_EXTRA_LINK_ARGS,
              ),
    ...
    Extension("mprans.cSW2DCV", ["proteus/mprans/cSW2DCV.pyx"],
              depends=["proteus/mprans/SW2DCV.h"] + \
              ["proteus/ModelFactory.h", "proteus/CompKernel.h"],
              language="c++",
              include_dirs=[numpy.get_include(), 'proteus'],
              extra_compile_args=PROTEUS_EXTRA_COMPILE_ARGS + \
